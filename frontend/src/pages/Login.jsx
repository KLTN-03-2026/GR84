...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (reason === 'session_required') {
      ...
      setSessionMessage('Phiên đăng nhập đã bị hủy. Vui lòng đăng nhập lại.');
    } else if (reason === 'token_expired') {
      setSessionMessage('Token đã hết hạn. Vui lòng đăng nhập lại.');
    }

    // Clear return URL after showing message
    if (returnUrl) {
          ...
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-6 items-center py-4 lg:py-2 -mt-6 lg:-mt-16">
            ...
            <section className="w-full max-w-[32rem] mx-auto lg:mx-0 lg:ml-auto lg:mr-8 px-3 sm:px-4">
              ...
              >
                ...
                {(error || adminStore.error || sessionMessage) && (
                  <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-xl">
                    <p className="text-red-600 text-sm text-center">{error || adminStore.error || sessionMessage}</p>
                  </div>
                )}
